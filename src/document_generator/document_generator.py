...
class DocumentGenerator:
    ...
    def generate_response_llm(self, country: str, budget: float, model: str = "deepseek/deepseek-r1"):
        load_dotenv()
        ...
        response = client.chat.completions.create(
            ...
            messages=[
                ...
                {
                    "role": "user",
                    "content": f"""These are the data obtained from the allocator for the selected country: {country}, with this initial budget: {budget}.
    ...
    def save_response_to_file(self, country: str, budget: float, model: str = "deepseek/deepseek-r1", return_response=True):
        response_llm = self.generate_response_llm(country, budget, model)
...
#     document_generator = DocumentGenerator(system_prompt, folder_path)
#     # model="mistralai/codestral-2501"
#     document_generator.save_response_to_file(country, budget, model="mistralai/codestral-2501")
